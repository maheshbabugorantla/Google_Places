...
import com.example.maheshbabugorantla.google_places.groceries.GroceriesSelect;

import static com.example.maheshbabugorantla.google_places.R.id.intolerances;
import static com.example.maheshbabugorantla.google_places.R.id.maxFat;
import static com.example.maheshbabugorantla.google_places.R.id.maxProtein;
import static com.example.maheshbabugorantla.google_places.R.id.minProtein;
import static com.example.maheshbabugorantla.google_places.R.id.seekMaxFats;
            ...
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                if (s.length() > 1) {
                    ...
                    if (ingredientsList[index].length() > 1) {
                        ...
                        //new IngredientsTask().execute(url);
                    }
                }
            }
